"use strict";exports.id=5024,exports.ids=[5024],exports.modules={95024:(e,r,t)=>{t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});let template=(e,r)=>{let t=e.toolheads?.some(e=>!e.toolNumber&&e.probe?.id==="beacon"),o=t?`
# The primary toolhead is configured to use the beacon probe.
# Because the V-Core 4 aluminium bed plate extends beyond the printable area, we can successfully
# use the beacon probe to scan a larger area, both for proximity and contact:

[bed_mesh]
mesh_min: 20,20
mesh_max: ${e.size.x-20},${e.size.y-20}

[beacon]
contact_mesh_min: 20, 20
contact_mesh_max: ${e.size.x-20},${e.size.y-20}
`:"";return`
