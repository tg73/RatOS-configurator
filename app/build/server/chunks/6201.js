"use strict";exports.id=6201,exports.ids=[6201],exports.modules={53086:(e,r,t)=>{t.r(r),t.d(r,{initialPrinterCfg:()=>initialPrinterCfg,template:()=>template});var i=t(7769);let template=async(e,r)=>`
...
${(0,i.maybeRenderBeaconOverrides)(e,{proximityMargins:{left:20,right:20,top:20,bottom:20},contactMargins:{left:20,right:20,top:20,bottom:20},offset:{x:0,y:19.5}})}
...
${r.renderChamberLighting()}

${r.renderToolheadAlignmentSystemHardware()}

${r.renderChamberAirFilter()}
...
${r.renderToolheadAlignmentSystemConfigHelpers()}
